...
// Штучне сховище даних — імітує базу даних.
// Клас є статичним, дані ініціалізуються один раз при першому зверненні.
// Доступ до сховища є лише у класі TaskRepository.
...
internal static class FakeStorage
{
    ...
    // Список завдань (зв'язок з проєктом через ProjectId)
    ...
    static FakeStorage()
    {
        ...
        {
            // Проєкт 1 — Дипломна робота (10 завдань)
            ...
            // Проєкт 2 — Корпоративний портал (2 завдання)
            new(11, 2, "Зібрати вимоги від замовника",     "Провести інтерв'ю з HR, IT та бухгалтерією для збору вимог",       TaskPriority.Critical, new DateTime(2025, 3, 10),  true),
            ...
            // Проєкт 3 — Особистий блог (без завдань, порожній проєкт)
        };
    }
}
